...
class WorkOrder(Base):
    ...
    event_id = Column(String(50), index=True, nullable=True)
    ...
    status = Column(String(30), default="OPEN", index=True) # OPEN, ASSIGNED, IN PROGRESS, REPAIRED, REPAIR_VERIFIED, REPAIR_FAILED, RESOLVED, CLOSED, CANCELLED
